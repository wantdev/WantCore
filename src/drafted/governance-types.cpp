...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "WantNetwork") type = WantNetwork;
    if(strType == "WantNetworkVariable") type = WantNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == WantNetwork) s = "WantNetwork";
    if(type == WantNetworkVariable) s = "WantNetworkVariable";
