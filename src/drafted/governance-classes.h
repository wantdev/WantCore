 ...
 *
 *   // network
 *   CWantNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.want.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CWantNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: WantNetwork
// //   -- signature requirements : Key1(User)
// class CWantNetworkVariable : public CGovernanceObject
// {
// private:
