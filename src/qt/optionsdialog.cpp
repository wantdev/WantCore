    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("WANT-light"), QVariant("light"));
    ui->theme->addItem(QString("WANT-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("WANT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("WANT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("WANT-traditional"), QVariant("trad"));
