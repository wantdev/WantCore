    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Want Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Want Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  want-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Want in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 WANT, 0.1 WANT, 1 WANT and 10 WANT -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://wantdev.atlassian.net/wiki/display/DOC/PrivateSend\">https://wantdev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Want Core is shutting down...") + "<br /><br />" +
