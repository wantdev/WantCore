    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Want Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Want address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and want: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Want Core"), this);
    aboutAction->setStatusTip(tr("Show information about Want Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Want Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Want addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Want addresses"));
    ...
    openAction->setStatusTip(tr("Open a want: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Want Core help message to get a list with possible Want Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Want Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Want network", "", count));
    } else {
...
{
    QString strTitle = tr("Want Core"); // default title
