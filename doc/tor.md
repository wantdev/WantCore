TOR SUPPORT IN WANT CORE
=======================

It is possible to run Want Core as a Tor hidden service, and connect to such services.
...
1. Run Want Core behind a Tor proxy
----------------------------------

The first step is running Want Core behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./wantd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./wantd -proxy=127.0.0.1:9050


2. Run a Want Core hidden server
-------------------------------
...
your wantd's P2P listen port (9992 by default).
	...
	-externalip=X   You can tell Want Core about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/wantcore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./wantd -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./wantd ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./wantd -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known Want Core Tor relays
------------------------------------
...
Want Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Want Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Want Core is listening, and
