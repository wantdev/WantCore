...
* Update translations, see [translation_process.md](https://github.com/wantdev/WantCore/blob/master/doc/translation_process.md#syncing-with-transifex)
...
### Build and sign Want Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit want=v${VERSION} ../want/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [want-detached-sigs](https://github.com/wantdev/WantCore-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
