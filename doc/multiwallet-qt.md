...
Only requiring some minor changes is want.cpp.
...
Changes to want.cpp
----------------------
want.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
