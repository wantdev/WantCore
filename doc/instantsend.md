...
This mechanism has been integrated into Bitcore-Node-Want which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wantdev/insight-api-want#web-socket-api](https://github.com/wantdev/insight-api-want#web-socket-api)
* API: [https://github.com/wantdev/insight-api-want#instantsend-transactions](https://github.com/wantdev/insight-api-want#instantsend-transactions)
...
By default, the Want Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Want Core daemon:
